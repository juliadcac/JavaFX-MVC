...
public class FXMLAnchorPaneRelatoriosQtdeProdutosController implements Initializable {
    ...
    @FXML
    private TableColumn<Produto, Integer> tableColumnProdutoQtde;
    ...
    public void carregarTableViewProdutos() {
        ...
        tableColumnProdutoQtde.setCellValueFactory(new PropertyValueFactory<>("quantidade"));
    ...
    public void handleImprimir() throws JRException {
        InputStream in = getClass().getResourceAsStream("../relatorios/JAVAFXMVCRelatorioProdutos.jasper");
//        URL url = getClass().getResource("/javafxmvc/relatorios/JAVAFXMVCRelatorioProdutos.jasper");
        ...
        //false: não deixa fechar a aplicação pricipal
